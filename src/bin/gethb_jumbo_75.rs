...
fn generate_table(
    ratio: f64,
    table: &mut HashMap<[u8; 16], [u8; 100], SeedableState>,
) -> Vec<u128> {
...
fn get_benchmark(
    table: &HashMap<[u8; 16], [u8; 100], SeedableState>,
    overhead: u64,
    keys: &[u128],
) -> Results {
...
fn main() {
    ...
    let mut table: HashMap<[u8; 16], [u8; 100], SeedableState> =
    ...
    let filename = format!("benchmark_results_hb_jumbo_75_{}.csv", ratio);
